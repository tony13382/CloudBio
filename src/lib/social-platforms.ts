...
export const SOCIAL_PLATFORMS: SocialPlatform[] = [
  ...
  { id: "messenger", label: "Messenger", placeholder: "https://m.me/username" },
  { id: "pixiv", label: "Pixiv", placeholder: "https://pixiv.net/users/12345678" },
  { id: "feedly", label: "Feedly", placeholder: "https://feedly.com/i/subscription/feed/..." },
  { id: "buymeacoffee", label: "Buy Me a Coffee", placeholder: "https://buymeacoffee.com/username" },
  { id: "wikipedia", label: "Wikipedia", placeholder: "https://en.wikipedia.org/wiki/..." },
